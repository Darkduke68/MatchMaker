...
from .models import IMPORTANCE_LEVELS, Answer, Question


class UserResponseForm(forms.Form):
    question_id = forms.IntegerField()
    answer_id = forms.IntegerField()
    importance_level = forms.ChoiceField(choices=IMPORTANCE_LEVELS)
    their_answer_id = forms.IntegerField()
    their_importance_level = forms.ChoiceField(choices=IMPORTANCE_LEVELS)
    ...
    def clean_their_answer_id(self):
        ...
        try:
            Answer.objects.get(id=their_answer_id)
        except:
